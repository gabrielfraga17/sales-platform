...
ALLOWED_ORIGINS="${ALLOWED_ORIGINS:-https://palhas-douradas-frontend-337796419771.southamerica-east1.run.app,https://palhas-douradas-frontend-sytosdcb4q-rj.a.run.app}"
